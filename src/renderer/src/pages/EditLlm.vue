<template>
  <div class="p-2 flex flex-col gap-2">
    <div
      class="w-full gap-2 p-2 bg-primary-700 rounded-md flex justify-end items-center"
    >
      <Button
        label="返回"
        @click="$router.back()"
    ...
    <div
      class="grid grid-cols-[4rem_1fr] items-center w-full gap-2 p-2 bg-gray-100 rounded-md"
    >
      ...
      <InputText
        v-model="llm.proxy"
        class="w-full"
        placeholder="如果访问模型地址需要代理，请设置代理地址"
      />
      ...
      <div class="flex gap-2">
        <RadioButton
          v-model="llm.visionReasoningEffort"
          name="none"
          value=""
          class=""
        />
